...
/**
 * 提案手法 2: 交叉を最小のスループットを示すAPからする/ 一様交叉←こっちがメイン
 *
 * @author ginnan
 */
public class EventOfGenericAlgorithm2 extends Event {
    ...
    public EventOfGenericAlgorithm2(double time, Scenario scenario) {
        super(scenario);
...
//System.out.println(unum);
        ...
        Event next_event = new EventOfGenericAlgorithm2(time, _scenario);
