...
/**
 * 提案手法 3: 評価値を平均スループットに、突然変異は確率で個体の要素を交換、(交叉は一様交叉)
 *
 * @author ginnan
 */
public class EventOfGenericAlgorithm3 extends Event {
    ...
    public EventOfGenericAlgorithm3(double time, Scenario scenario) {
        super(scenario);
...
//System.out.println(deb);
        ...
        Event next_event = new EventOfGenericAlgorithm3(time, _scenario);
